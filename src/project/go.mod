...
require (
	...
	github.com/qor/admin v0.0.0-20201030081936-7a582b8f872a
	...
	github.com/qor/sorting v0.0.0-20201007033714-f8eb1268875a
	github.com/qor/validations v0.0.0-20171228122639-f364bca61b46 // indirect
	github.com/rosberry/ginlog v0.0.0-20190125111700-15a79efc6067
